...
Educational and training materials are valuable resources
for the entire software community.  Contributions are
welcome under the following guidelines.
...
1.  If you wish to change this lesson,
    please work in <https://github.com/frobnitzem/hpl-hpcg>,
    which can be viewed at <https://frobnitzem.github.io/hpl-hpcg>.

2.  If you wish to change the example lesson,
    please work in <https://github.com/carpentries/lesson-example>,
    which documents the lesson format
